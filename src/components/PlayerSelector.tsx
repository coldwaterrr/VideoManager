  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1.5 rounded-lg bg-zinc-800 px-2.5 py-1.5 text-xs text-white transition hover:bg-zinc-700"
        title="切换播放器"
      >
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-2 z-50 w-64 rounded-lg border border-zinc-700 bg-zinc-900 shadow-xl overflow-hidden">
            ...
            {PLAYER_OPTIONS.map((opt) => (
              ...
              >
                <div className={`flex-shrink-0 ${current === opt.value ? 'text-violet-400' : 'text-zinc-500'}`}>
                  {opt.icon}
                </div>
